...
/***/ "./src/features/series/seriesComponent.ts":
/*!************************************************!*\
  !*** ./src/features/series/seriesComponent.ts ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./seriesComponent.css */ "./src/features/series/seriesComponent.css");
var m = __webpack_require__(/*! mithril */ "./node_modules/mithril/mithril.js");
var seriesService_1 = __webpack_require__(/*! features/series/seriesService */ "./src/features/series/seriesService.ts");
var SeriesComponent = /** @class */ (function () {
    function SeriesComponent() {
    }
    SeriesComponent.prototype.oninit = function () {
        seriesService_1.default.list('hallo', 10, 20);
        return seriesService_1.default.details('hallo');
    };
    SeriesComponent.prototype.view = function () {
        return m('h1', 'Series');
    };
...
/***/ "./src/features/series/seriesService.ts":
/*!**********************************************!*\
  !*** ./src/features/series/seriesService.ts ***!
  \**********************************************/
/*! no static exports found */
...
var SeriesService = /** @class */ (function () {
    ...
    SeriesService.details = function (seriesId) {
        return api_1.default.get('series/' + seriesId)
            .then(function (x) { return x.series; });
    };
    SeriesService.list = function (filter, skip, take) {
        var query = { filter: filter, skip: skip, take: take };
        return api_1.default.get('series', query)
            .then(function (x) { return x.items; });
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./layoutComponent.css */ "./src/layoutComponent.css");
var m = __webpack_require__(/*! mithril */ "./node_modules/mithril/mithril.js");
...
var Api = /** @class */ (function () {
    ...
    Api.get = function (url, query) {
        return m.request(createUrl(url, query), { method: 'GET' });
    };
    return Api;
}());
exports.default = Api;
...
function createQuery(query) {
    ...
    return '?' + keys
        .map(function (key) { return toQueryParam(key, query[key]); })
